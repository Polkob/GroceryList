...
[1.3 Показатели качества](#14-показатели-качества)  
[1.4 Пути реализации сквозной функциональности](#15-пути-реализации-сквозной-функциональности)<br>
[1.5 Структурная схема приложения](#16-структурная-схема-приложения)<br>
...
В данном приложении все компоненты приложения разворачиваются на одном центральном сервере, а все данные о пользователях, их списке покупок базе данных.<br>
...
## 1.4 Пути реализации сквозной функциональности
...
## 1.5 Структурная схема приложения

![Структурная схема приложения](<img width="649" alt="Сруктурная схема" src="https://github.com/Polkob/GroceryList/assets/93399289/f251e75f-9a4e-44dd-ac4b-fc95f4172e25">
)
